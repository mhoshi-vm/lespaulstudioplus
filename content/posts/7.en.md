...
For building images from source code it uses [kpack](https://github.com/pivotal/kpack), which brings [Cloud Native Buildpacks](https://buildpacks.io/) to Kubernetes.
