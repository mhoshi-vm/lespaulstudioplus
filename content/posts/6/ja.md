...
[TMCで学ぶOPA](../tmc-tmc_demanabu_opa)シリーズでも紹介したように、OPAは強力なツールです。
Rego言語をテストするのにRego Playgroundが使えます。<!--more-->
...
さらに、それにもとづいた、constraintsを作成します。
この例では、Namespaceの作成時にひっかかるようにしています。
